# Introdução ao Criar um App no React.

Este projeto foi inicializado com [Criar um App no React](https://github.com/facebook/create-react-app).
...
Consulte a seção sobre [desenvolvimento](https://facebook.github.io/create-react-app/docs/deployment) para obter mais informações.
